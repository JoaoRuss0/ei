...
sudo docker run -d --name assetlink -p 8080:8080 -e QUARKUS_DATASOURCE_REACTIVE_URL="mysql://ieproject202620260510182750498100000001.chvkqwfiehtt.us-east-1.rds.amazonaws.com:3306/VPPaaS" -e KAFKA_BOOTSTRAP_SERVERS="ec2-3-87-22-231.compute-1.amazonaws.com:9092,ec2-3-83-17-222.compute-1.amazonaws.com:9092,ec2-44-202-0-92.compute-1.amazonaws.com:9092" joaoruss0/assetlink:1.0.0-SNAPSHOT
